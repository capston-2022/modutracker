...
import com.example.modutracker.MyReceiver.Constant.Companion.CHANNEL_ID
...
class MyReceiver : BroadcastReceiver() {
    ...
    private fun deliverNotification(context: Context) {
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentTitle("modutracker") // 제목
            .setContentText("오늘은 어떤 하루였나요?") // 내용
            .setContentIntent(contentPendingIntent)
            .setPriority(NotificationCompat.PRIORITY_HIGH)
            .setAutoCancel(true)//창 클릭시 자동 삭제
    ...
    fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationChannel.description = "오늘의 기분을 기록하세요!" // 채널 정보
